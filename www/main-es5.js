...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "ion-label:hover {\n  cursor: pointer;\n}\n\nion-label {\n  margin-left: 10px !important;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
                  ...
                  case 0:
                    ...
                    this.fcm.onNotification().subscribe(function (data) {
                      ...
                      if (data.wasTapped) {
                        ...
                        _this2.router.navigate(['/purchase-orders']);
                      } else {
                ...
                switch (_context2.prev = _context2.next) {
                  case 0:
                    ...
                    return this.httpService.get(url).then(function (response) {
                      _this3.utilityService.presentAlert('Rebooting', response.message);
                    })["catch"](function (error) {
                      console.log('Error', error);

                      _this3.utilityService.presentAlert('Error!', error.message);
                    });
                ...
                switch (_context3.prev = _context3.next) {
                  case 0:
                    ...
                    return this.storageService.getStoredData().then(function (data) {
                      var user = _this4.storageService.get('user');
            ...
            return regeneratorRuntime.wrap(function _callee4$(_context4) {
              while (1) {
                switch (_context4.prev = _context4.next) {
                  ...
                  case 2:
                    this.supplierDetails = _context4.sent;
                  ...
                  case 0:
                    ...
                    return this.httpService.get(url).then(function (goodsReceiptNotes) {
                      if (goodsReceiptNotes) {
                        _this5.grn = goodsReceiptNotes;
                        console.log('Goods Receipt Notes...', _this5.grn);
                      }
                    })["catch"](function (error) {
                      console.log('Error', error);
                    });
  ...
  function srcPagesPurchaseOrderViewPurchaseOrderViewPageScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = ".my-thin-col {\n  flex: 0 0 4px;\n}\n\n.text2 {\n  display: inline-block;\n  vertical-align: middle;\n}\n\nion-item {\n  padding: 0;\n}\n\n.container {\n  display: flex;\n  justify-content: space-around;\n  align-items: flex-start;\n  border: 2px dashed rgba(114, 186, 94, 0.35);\n  height: 400px;\n  background: rgba(114, 186, 94, 0.05);\n}\n\n.stick {\n  position: -webkit-sticky;\n  position: sticky;\n  top: 0;\n}\n\n.ion-col-fixed {\n  size: \"8\";\n}\n\n.bgcolor {\n  background: #F5F5F6;\n}\n\n.footer {\n  width: 100%;\n  left: 0;\n  right: 0;\n  bottom: 0;\n  z-index: 1;\n  color: #070000;\n}\n\n.ion-col {\n  background: #F5F5F6;\n  text-align: center;\n}\n\n.ion-col2 {\n  background: #F5F5F6;\n  text-align: right;\n}\n\n.button-size {\n  width: 80%;\n}\n\n.bcolor {\n  color: gray;\n}\n\n.addIcon {\n  width: 40px;\n  height: 50px;\n  padding-left: 0;\n}\n\n.icons {\n  display: inline-block;\n  vertical-align: middle;\n  width: 30px;\n  height: 30px;\n  margin-left: 9px;\n}\n\n.icons2 {\n  display: inline-block;\n  vertical-align: middle;\n  width: 35px;\n  height: 35px;\n  margin-left: 9px;\n}\n\n.text-align-middle {\n  position: relative;\n  transform: translateY(10px);\n}\n\n.card {\n  box-shadow: none !important;\n}\n\nion-card-content .icons {\n  display: inline-block;\n  vertical-align: middle;\n  width: 32px;\n  height: 32px;\n  margin-left: 10px;\n}\n\nion-card-content ion-row {\n  margin-top: 3px;\n}\n\n.item-inner {\n  border-style: unset !important;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
      ...
      _createClass(PurchaseOrderViewPage, [{
        ...
        value: function ionViewWillEnter() {
          ...
          this.platform.backButton.subscribeWithPriority(10, function () {
            ...
            _this6.router.navigate(['purchase-orders']);
          });
        }
      }, {
        key: "ngOnInit",
                ...
                switch (_context6.prev = _context6.next) {
                  case 0:
                    ...
                    return this.httpService.get(url).then(function (purchaseOrders) {
                      if (purchaseOrders) {
                        _this7.purchaseOrder = purchaseOrders[0];
                        _this7.items = purchaseOrders[0].items; // console.log(this.purchaseOrder);
                      }
                    })["catch"](function (error) {
                      console.log('Error', error);
                    });
            ...
            return regeneratorRuntime.wrap(function _callee8$(_context8) {
              while (1) {
                switch (_context8.prev = _context8.next) {
                  case 0:
                    serverURL = this.rootURL + actionURL;
                    return _context8.abrupt("return", this.httpClient.post(serverURL, body, this.getHeaderOptions()).toPromise().then(function (data) {
                      // data = data.trim();
                      console.log('Sync URL', serverURL);
                      console.log('Sync Response', data);
                      console.log('-----------------------------------------------------------');
            ...
            return regeneratorRuntime.wrap(function _callee9$(_context9) {
              while (1) {
                switch (_context9.prev = _context9.next) {
                  case 0:
                    serverURL = this.rootURL + actionURL;
                    return _context9.abrupt("return", this.httpClient.put(serverURL, body, this.getHeaderOptions()).toPromise().then(function (data) {
                      // data = data.trim();
                      console.log('Sync URL', serverURL);
                      console.log('Sync Response', data);
                      console.log('-----------------------------------------------------------');
                ...
                switch (_context11.prev = _context11.next) {
                  case 0:
                    ...
                    return this.storage.forEach(function (value, key, iterationNumber) {
                      ...
                      _this12.storageMap = _storageMap;
                    });
              ...
              while (1) {
                switch (_context12.prev = _context12.next) {
                  case 0:
                    _context12.next = 2;
                    return this.storageService.getStoredData().then(function (data) {
                      var user = _this13.storageService.get('user');

                      if (user.token) {
                        var verifyOTPURL = '/user/verifyToken';

                        _this13.httpService.get(verifyOTPURL).then(function (datas) {
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! D:\Development\Grid\medics-grid-app\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
